...
class WatchlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create watchlist" do
    assert_difference('Watchlist.count') do
      post watchlists_url, params: { watchlist: { description: @watchlist.description, name: @watchlist.name } }, as: :json
    end
  ...
  test "should update watchlist" do
    patch watchlist_url(@watchlist), params: { watchlist: { description: @watchlist.description, name: @watchlist.name } }, as: :json
    assert_response 200
  end
